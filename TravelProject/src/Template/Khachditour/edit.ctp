...
<form id="myForm" action="/Khachditour/edit/<?php echo $khachditour['0']['MaKhach']?>" method="post">
	<p>Tên khách hàng</p>
	<p><input class="form-control" type="text" name="TenKhach" value="<?php echo $khachditour['0']['TenKhach']?>"></p>
	<p>Mã đặt tour</p>
	<p>
	...
	<p>Ngày sinh</p>
	<p><input type="text" class="form-control datepicker" name="NgaySinhKhach" value="<?php echo $khachditour['0']['NgaySinhKhach']?>"></p>
	<p>Địa chỉ</p>
	<p><input class="form-control" type="text" name="DiaChiKhach" value="<?php echo $khachditour['0']['DiaChiKhach']?>"></p>
	<p>Giới tính</p>
	...
	<p>Thành tiền</p>
	<p><input class="form-control" type="text" name="ThanhTien" value="<?php echo $khachditour['0']['ThanhTien']?>"></p>
